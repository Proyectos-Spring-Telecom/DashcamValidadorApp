...
/// Modelo para representar un viaje activo de tarifa dinámica
/// Ahora también acumula distancia en tiempo real durante el trayecto
class DynamicFareTrip {
  ...
  double? endLat;
  double? endLon;
  double? distance; // en metros (distancia total acumulada)
  ...
  /// Calcula la distancia entre el punto de inicio y fin en metros
  ...
  /// La distancia ya está acumulada durante el trayecto en tiempo real
